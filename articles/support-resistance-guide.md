---
title: "支撑阻力与磁吸位（第七层）"
slug: "/cross-asset/support-resistance-guide"
meta_description: "深度解析 Al Brooks PA 中的 支撑阻力与磁吸位（第七层）。完整规则、胜率数据与实战技巧。"
cluster: "跨资产应用"
module_id: "M8_UNIFIED"
pattern_id: "SUPPORT_RESISTANCE"
direction: "both"
...
- **SR_R1**: 磁吸位优先级：昨收>昨高低>今开>前TR边缘>突破点>高潮棒极值>Gap>EMA20
- **SR_R2**: 严禁在明显阻力位做多，严禁在明显支撑位做空
- **SR_R3**: 被突破的阻力→支撑（回测入场），被跌破的支撑→阻力
...
**Q1: 支撑阻力与磁吸位（第七层） 的信号K线如何判断？**

根据规则，信号K线需要满足方向性（阳线/阴线）、收盘位置（上/下半部）和实体饱满度等条件。具体请参考上方触发条件。

**Q2: 支撑阻力与磁吸位（第七层） 失败后怎么办？**

失败后应等待下一个更高级别的确认信号，避免连续止损。

**Q3: 支撑阻力与磁吸位（第七层） 适用于哪些市场？**

Price Action 反映的是人类交易心理，因此 支撑阻力与磁吸位（第七层） 适用于股票、期货、外汇、加密货币等所有流动性充足的市场。
